...
export function DashboardStats() {
 ...
 if(!isLoaded){
  ...
  return (
    <div className="grid grid-cols-2   gap-y-3 lg:gap-0   lg:grid-cols-4">
      {stats.map((stat, index) => (
        <Card
          key={stat.name}
          className="  mx-auto w-44 h-40 md:w-44 md:h-44 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:scale-105 hover:border-gray-600/50 backdrop-blur-sm"
          style={{ 
