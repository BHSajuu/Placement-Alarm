...
export const addCompanyFromProposal = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // SANITIZE DEADLINE: If it's not a valid date string, set it to undefined
    let validDeadline = args.companyData.deadline;
    if (validDeadline === "Not mentioned" || validDeadline === "N/A" || !validDeadline) {
